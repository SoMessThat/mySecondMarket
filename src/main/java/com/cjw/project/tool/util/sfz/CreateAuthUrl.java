package com.cjw.project.tool.util.sfz;
...
public class CreateAuthUrl {
	...
	public static String getUrl(String name,String idCode){
		String urlStr="http://121.40.136.150:8080/IdInDataAu/api/authenInfoApi.htm";
		String userId="100035";
		String ts =System.currentTimeMillis()+"";
		String orderNo =ts;
		String mKey="J3AzVl9955U5p951vB11f3B779l9RNF5";//MD5密钥
		String dateString ="";
		strDefaultKey="3b7d3p177B19TJ1s3r931MV5a3rop7lM";//DES密钥
		try {
		...
		String url = "";
		try {
			url = urlStr+"?userId="+userId+"&coopOrderNo="+orderNo+"&auName="+nameDes+"&auId="
...
//			System.out.println(sendHttpRequest(urlStr,params));
	...
	public static void main(String[] args){
		...
		String dateString ="";
		String name="刘鹏";
		String idCode="320623196910110014";
		strDefaultKey="3b7d3p177B19TJ1s3r931MV5a3rop7lM";//DES密钥
		try {
			name=URLEncoder.encode(name,"UTF-8");
			Date currentTime = new Date();
