package com.cjw.project.tool.bean;
...
public class Query<T> {
     ...
     * 添加in查询
     */
    public Query<T> addIn(String field , List<Object> list) {
     ...
     */
    public Query<T> addIn(String field , Object[] objects) {
     ...
     * @param end
     */
    public Query<T> addBetween(String fieldName ,Long begin, Long end) {
        if (begin == null  || end == null) return this;
        if (begin > end || begin == 0 || end == 0) return  this;
     ...
     * @return
     */
    public Query<T> addBetween(String fieldName ,Object begin, Object end) {
        if (begin == null  || end == null) return this;
        betweens.put(fieldName ,new Between( begin ,end)) ;
        return this;
    }
     ...
     * @param value
     */
    public Query<T> addEq(String fieldName , Object value) {
     ...
     * @return
     */
    public Query<T> addGt(String fieldName , Object value) {
        if (value == null || "null".equals(value) || "NULL".equals(value)) {
            return  this;
        }
     ...
     * @return
     */
    public Query<T> addLt(String fieldName , Object value) {
        if (value == null || "null".equals(value) || "NULL".equals(value)) {
            return  this;
        }
     ...
     * @param value
     */
    public Query<T> addLike(String fieldName , String value) {
     ...
     * @param value
     */
    public Query<T> addPrefixLike(String fieldName , String value) {
     ...
     * @param fieldName
     */
    public Query<T> addIncludeField(String fieldName) {
     ...
     * @param pageSize
     */
    public Query<T> setPaged(int pageNo ,int pageSize) {
        if (pageNo == 0) {
            pageNo = 1;
        }
        if (pageSize == 0) {
     ...
     * @param dbOrder
     */
    public Query<T> addOrder(String name , DBOrder dbOrder) {
